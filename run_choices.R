...
site_name = "Dinaka" # Site name - the image data should be named Site_name_stack.tif the training data 
# site_name_train_poly.shp
...
writeRaster(mod.pred.fac, filename = paste0("data_out/",site_name,"/",site_name,"_",learner_ML,"_Predict_Map.tif"), overwrite=TRUE)


### Exporting Data ------
# Exporting confusion matrix
as.data.frame(res.preds)
write.xlsx(res.preds, paste0("data_out/",site_name,"/Confusion_res.preds_",site_name,"_",learner_ML,".xlsx"), rowNames=FALSE)
...
write.xlsx(b, paste0("data_out/",site_name,"/",site_name,"_MLR_bench_results_",learner_ML,".xlsx"), rowNames=FALSE)


#Exporting benchmark plot
ggsave(
  p2,
  filename = paste0("data_out/",site_name,"/",site_name,"benchmark_model_classif_ac.png"),
  width =16,
  height = 16,
  units = "cm"
)
...
ggsave(
  p3,
  filename = paste0("data_out/",site_name,"/",site_name,"_",learner_ML,"_model_classif_ac.png"),
  width =16,
  height = 16,
  units = "cm"
)
